...
export class Duration {
  ...
  plus = (other) => {
         // YOUR CODE
         const newSecond = this._totalSeconds + other._totalSeconds;
         return new Duration(newSecond);
  };
   ...
   * 
   * @param {Duration} other - a new duration
   * @returns {Duration} - returns the new duration
   */
  minus = (other) => {
         // YOUR CODE
         const newSecond = this._totalSeconds - other._totalSeconds;
