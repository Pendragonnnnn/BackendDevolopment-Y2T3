...
export default function ArticleList() {
  ...
  const handleAuthor = (id) => navigate(`/journalists/${id}/articles`);
...
function ArticleCard({ article, onView, onEdit, onDelete, onAuthor }) {
  return (
    <div className="article-card">
      <div className="article-title">{article.title}</div>
      <div className="article-author" onClick={() => onAuthor(article.journalist_id)}>
